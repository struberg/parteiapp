...
import at.gruene.parteiapp.platform.be.entities.listener.AuditedEntityListener;
...
public abstract class AuditedEntity<ID_TYPE> implements BaseEntity<ID_TYPE> {

    /**
     * The userId who entered the vote into the system
     */
    @Column(name="CREATED_BY", length= ColumnLength.USERID)
     ...
     */
    @Column(name="MODIFIED_BY", length= ColumnLength.USERID)
