...
CREATE TABLE BallotVote (id INTEGER NOT NULL, createdAt TIMESTAMP WITH TIME ZONE, createdBy VARCHAR(70), nominees VARCHAR(4000), voteNr INTEGER NOT NULL, optLock INTEGER, BALLOT_ID INTEGER, PRIMARY KEY (id));
